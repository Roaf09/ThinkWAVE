...
studentRouter.post("/achievements/favorites", validateBody(z.object({ achievementIds:z.array(z.string().min(1).max(120)).max(3) })), asyncHandler(setFavoriteAchievements));
