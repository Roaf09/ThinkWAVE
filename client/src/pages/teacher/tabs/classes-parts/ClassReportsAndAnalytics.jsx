...
export function ClassAnalyticsModal({ c, data, loading, mode, setMode, onClose }) {
  ...
  return <div className="tw-host-launch-backdrop" style={modalBackdrop} onMouseDown={onClose}>
    <div onMouseDown={(event) => event.stopPropagation()} className="tw-class-analytics-modal tw-host-launch-modal w-[min(96vw,1040px)] max-h-[92dvh] overflow-hidden" style={{ ...card(c, { background: solidModalBg(c), padding: 0, borderWidth: 3 }) }}>
...
export function StudentAnalyticsModal({ c, data, loading, onClose }) {
  ...
  return <div className="tw-host-launch-backdrop" style={modalBackdrop} onMouseDown={onClose}>
    <div onMouseDown={(event) => event.stopPropagation()} className="tw-class-student-analytics-modal tw-host-launch-modal w-[min(97vw,1080px)] max-h-[92dvh] overflow-hidden" style={{ ...card(c, { background: solidModalBg(c), padding: 0, borderWidth: 3 }) }}>
...
const modalBackdrop = { zIndex: 9000 };
